          ...
          <div class="col-12">
            <div class="custom-block custom-block-full custom-block-no-hover">
              <div class="custom-block-info">
                ...
                <form action="edit-novel.php" method="post" class="custom-form me-3" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <input name="title" type="text" class="form-control" id="title" placeholder="Judul novel"
                      value="<?= getOldInput('title', $novel['title']); ?>">
                    <?= getInputError('title'); ?>
                  </div>
                  <div class="form-group">
                    <textarea name="description" class="form-control" id="description" cols="30" rows="10"
                      placeholder="Deskripsi (maksimal 2.500 karakter)"><?= getOldInput('description', $novel['description']); ?></textarea>
                  ...
                  <div class="form-group">
                    <select id="genres" class="form-control" name="genres[]" multiple>
                      ...
                      <?php $oldGenres = getOldInput('genres', $genreNovel); ?>
